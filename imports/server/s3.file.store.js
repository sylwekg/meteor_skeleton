...
// var S3 = require('aws-sdk/clients/s3'); // http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/S3.html
...
if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
  ...
  const _origRemove = Collections.userFiles.remove;
  Collections.userFiles.remove = function (search) {
...
Meteor.publish('filesS3.images.all', function () {
